...
def compute_p_value():
    ...
    '''
        ...
        # hotspot
        # table = [[PLP_in_hotspot, BLB_in_hotspot],
        # Number of disease-related and non disease-related variants in hotspot areas
        # [PLP_in_all - PLP_in_hotspot, BLB_in_all - BLB_in_hotspot]]
        # Number of disease-related and non disease-related variants in non
        # hotspot areas

        # coldspot
        table = [[BLB_in_coldspot, PLP_in_coldspot],
                 # Number of disease-related and non disease-related variants
                 # in coldspot areas
                 [BLB_in_all - BLB_in_coldspot,
                  # Number of disease-related and non disease-related variants
                  # in non coldspot areas
                  PLP_in_all - PLP_in_coldspot]]
        ...
        # container = [gene, str(PLP_in_coldspot), str(BLB_in_coldspot), str(PLP_in_all), str(BLB_in_all), str(p_value),
        #             str(oddsratio)]
        # result.write(f"{'\t'.join(container)}\n")
